...
/**
 * @brief	Moves the bytes from src to dst location
 *
 ...
 * @param length Of bytes to move from the source to the destination.
 *
...
/**
 * @brief 	Resets to zero all the pointed memory
 *
...
/**
 * @brief 	Reverses the order of the bytes in src.
 *
 * This function takes the pointer to a memory location and a length in bytes and
 ...
 *
 * Given the pointer to a char data set, this will set a provided
 ...
 *
 * Given the pointer to a char data set, this will clear a provided
 ...
 *
 * Given the pointer to a char data set, this will read the provided
 ...
 *
 * Given the pointer to a char data set, this will set a number of elements
 ...
 *
 * Given the pointer to a char data set, this will set a clear a number
